...
//	    stone_age.tree_stump(recipe.ingredients, recipe.result, recipe.tool,recipe.chop)
//@startup_scripts
		event.custom({
			type: "stone_age:tree_stump",
			ingredient: recipe.ingredients,
...
//    stone_age.tree_stump("2x steampowered:bronze_sheet", "frostedheart:bronze_ingot", "#forge:hammers",3)
//        .chopTimes(3)
