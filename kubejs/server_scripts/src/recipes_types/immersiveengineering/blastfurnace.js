ServerEvents.recipes((event) => {
    ...
    let blastFurnaceRecipes = [
        ...
        ["immersiveengineering:ingot_nickel", "#forge:raw_materials/nickel", 400],
        ["minecraft:iron_ingot", "frostedheart:rusted_iron_ingot", 200],
        ["immersiveengineering:ingot_lead", "#forge:raw_materials/lead", 200],
        ["minecraft:gold_ingot", "#forge:raw_materials/gold", 200],
        ["immersiveengineering:ingot_silver", "#forge:raw_materials/silver", 200],
