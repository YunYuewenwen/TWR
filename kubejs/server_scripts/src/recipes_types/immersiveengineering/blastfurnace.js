ServerEvents.recipes((event) => {
    ...
    let blastFurnaceRecipes = [
        ...
        ["immersiveengineering:ingot_nickel", "immersiveengineering:raw_nickel", 400],
        ["minecraft:iron_ingot", "frostedheart:rusted_iron_ingot", 200],
        ["immersiveengineering:ingot_lead", "immersiveengineering:raw_lead", 200],
        // ["minecraft:gold_ingot", "frostedheart:raw_gold", 200],
        ["immersiveengineering:ingot_silver", "immersiveengineering:raw_silver", 200],
